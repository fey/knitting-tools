...
/**
 * Конструктор своего ритма по шагам (тикет #6, §5.1, §5.5, §6.3).
 *
 * Свёрнут за кнопку — первый экран несёт только пресеты (§6.3). Внутри —
 ...
 * как требует §6.3. RhythmPresets.vue при этом не тронут: она ничего не знает
 * про свой ритм.
 *
 ...
 * недобор и перебор, — а недобор дублируется строкой у живого числа рядов
 * (`RhythmPresets.vue`): конструктор сворачивается, и единственная строка ушла бы
 * с экрана вместе с ним.
 */
...
/** Потолок интервала (§6.3): шаг 1, потолок 6. */
