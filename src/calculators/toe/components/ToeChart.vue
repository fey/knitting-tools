  ...
  <section class="rounded border border-slate-200 p-3" data-testid="toe-chart">
    ...
    <div class="relative mt-2" data-testid="toe-chart-box">
      ...
      <!-- Бумага шторки: затенение связанного (§8). Снаружи скроллера, потому что закрывать
           ...
           Высота задана явно, а не низом обёртки: обёртка выше сетки на полосу линейки
           (§7) и на полосу горизонтальной прокрутки, и бумага, растянутая до её низа,
           тонировала бы и то, и другое — при нулевом прогрессе от неё оставалась ровно
           эта полоска поверх линейки. Явная высота кончает бумагу там же, где кончается
           сетка, и от полосы линейки со скроллбаром больше не зависит. -->
      <div
