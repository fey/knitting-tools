 ...
 *
 * **Подпись у конечных петель называет оба закрытия (тикет #15).** Шов и стягивание —
 * не два разных мыска, а один и тот же мысок с разным концом (§1): подпись даёт числа
 * обоих и оставляет выбор мастеру. Предупреждения здесь нет и не будет — восьмёрка
 * названа нормой русской практики в §9.6.
 *
  ...
  <section class="rounded border border-slate-200 p-4" data-testid="stitch-fields">
    ...
    <div class="mt-4">
      ...
      <p class="mt-1 text-sm text-slate-500" data-testid="final-explainer">
        Под трикотажный шов оставляют 16–24 петли, для стягивания — около 8. Мысок и там и там
        один и тот же, различается только закрытие: что выбрать, решает мастер.
      </p>
