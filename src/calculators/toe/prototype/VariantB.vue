 ...
 * вводку, ручки и «Итог», а на их месте остаётся одна строка-сводка с числами расчёта
 * и кнопкой возврата. Схема стоит там же, где стояла, в естественную высоту (§6),
...
<template>
  <div class="min-h-screen bg-white text-slate-900">
    ...
    >
      ...
      <!-- Свёрнутая панель: строка-сводка на месте ручек. Стоит там же, где стояли
           ручки, — возврат ищут там, где пропало. -->
      <div
        v-else
      ...
      >
        ...
        >
          ...
          <button
            ...
            @click="focus = true"
          >
            Убрать настройки, оставить схему
          </button>
        </div>
