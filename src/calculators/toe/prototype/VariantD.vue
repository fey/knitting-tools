 ...
 *   вплотную к кнопке вводки, в одной строке с ней: у свёрнутой это «Показать
 *   инструкцию», у развёрнутой — «Свернуть инструкцию», и место кнопки не меняется
 *   ни на пиксель. Поставленная рядом с блоком вводки, а не с его кнопкой, она ездила
 *   бы вбок вместе с шириной блока — свёрнутый он шириной в кнопку, развёрнутый в 42rem.
